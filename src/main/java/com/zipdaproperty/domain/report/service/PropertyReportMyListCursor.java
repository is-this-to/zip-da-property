...
public record PropertyReportMyListCursor(Instant createdAt, Long reportId) {

    private static final String DELIMITER = ":";

    public PropertyReportMyListCursor {
    ...
    public static PropertyReportMyListCursor firstPage() {
        return new PropertyReportMyListCursor(null, null);
    }

    public static PropertyReportMyListCursor from(Instant createdAt, Long reportId) {
        return new PropertyReportMyListCursor(
                Objects.requireNonNull(createdAt, "cursor createdAt은 필수입니다."),
                Objects.requireNonNull(reportId, "cursor reportId는 필수입니다.")
        );
    }

    public static PropertyReportMyListCursor decode(String encodedCursor) {
        ...
        try {
            ...
            return new PropertyReportMyListCursor(createdAt, reportId);
