...
7. `007_create_property_image_table.sql`
8. `007_create_property_verification_tables.sql`
9. `008_create_property_address_table.sql`
10. `009_create_property_member_integration_tables.sql`
11. `010_add_property_tenant_verification.sql`
12. `011_add_property_verification_expiration_index.sql`
13. `012_add_property_verification_evidence_cleanup_indexes.sql`
14. `013_add_property_verification_renewal_notification.sql`
15. `014_add_property_idempotency_cleanup.sql`
16. `015_create_property_risk_assessment_table.sql`
17. `016_create_property_report_table.sql`
18. `017_create_property_report_action_table.sql`
19. `018_create_property_report_appeal_table.sql`
20. `019_create_property_report_evidence_table.sql`
